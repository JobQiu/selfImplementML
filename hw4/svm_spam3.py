...
Cvals = [0.03,0.1,0.3,1,3,10,30,50]
sigma_vals = [2.2,2.4,2.6]
best_C = None
best_sigma = None
bese_score = 0
...
for sigma_ in sigma_vals:
    ...
    for C_ in Cvals:
        ...
        loss_history.extend(svm.train(KK,y_train,learning_rate=best_learning_rate/5.0,reg=C_,num_iters=6000,verbose=True,batch_size=KK.shape[0]))
        loss_history.extend(svm.train(KK,y_train,learning_rate=best_learning_rate/50.0,reg=C_,num_iters=6000,verbose=True,batch_size=KK.shape[0]))
